...
- [x] F1前端浏览器验收及产品统一review通过：文章22组、真实文章10组、原契约22组、原真实13组，以及password/build/check:api/format通过；产品独立HTTP7组和真实浏览器CRUD通过，源码及截图回读通过。F1已通过验收，等待产品统一commit；F2保持未开始，提交后明确放行才实施。
